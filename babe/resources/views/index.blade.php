...
<head>
    <title>Couponia - Index shop layout 2</title>
    <!-- meta info -->
...
<body class="boxed" style="background-image: url(img/patterns/giftly.png)">
                                    ...
                                    <ul>
                                        <li class="active"><a href="index-shop-layout-1.html">Shop Layout</a>
                                            <ul>
                                                ...
                                                <li class="active"><a href="index-shop-layout-2.html">Layout 2</a>
                                                </li>
            ...
            <div class="owl-carousel owl-slider" id="owl-carousel-slider" data-inner-pagination="true" data-white-pagination="true" data-nav="false">
                <div>
                    <div class="bg-holder">
                        ...
                        <div class="bg-front vert-center text-white text-center">
                            <h2 class="text-hero">New Bloke Collection</h2>
                            <p class="text-bigger">Lobortis dolor arcu auctor tempus lorem sed</p>
                            <p class="text-hero">Save up to 30%</p><a class="btn btn-lg btn-ghost btn-white btn-lg" href="#">Shop Now</a>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="bg-holder">
                        ...
                        <div class="bg-mask"></div>
                        <div class="bg-front vert-center text-white text-center">
                            <h2 class="text-hero">Modern DJ Sets</h2>
                            <p class="text-bigger">Habitasse facilisis imperdiet dapibus porttitor felis parturient</p>
                            <p class="text-hero">Save up to 30%</p><a class="btn btn-lg btn-ghost btn-white btn-lg" href="#">Shop Now</a>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="bg-holder">
                        ...
                        <div class="bg-mask"></div>
                        <div class="bg-front vert-center text-white text-center">
                            <h2 class="text-hero">Gatgets Giveaway</h2>
                            <p class="text-bigger">Magna natoque aenean malesuada nostra varius aenean</p>
                            <p class="text-hero">Save up to 60%</p><a class="btn btn-lg btn-ghost btn-white btn-lg" href="#">Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-4">
                            <div class="product-thumb">
                                ...
                                <div class="product-inner">
                                    ...
                                    <p class="product-desciption">Convallis per ultricies tempus risus ligula et porttitor</p>
                                ...
                                <div class="product-inner">
                                    ...
                                    <div class="product-meta">
                                        <ul class="product-price-list">
                                            ...
                                            <li><span class="product-old-price">$207</span>
                                            </li>
                ...
                <div class="col-md-3">
                    <div class="product-thumb">
                        ...
                        <div class="product-inner">
                            ...
                            <p class="product-desciption">Consectetur morbi luctus orci per ridiculus condimentum magnis</p>
                            <div class="product-meta">
                                <ul class="product-price-list">
                                    ...
                                    <li><span class="product-save">Save 51%</span>
                                    </li>
                                </ul>
                ...
                <div class="col-md-3">
                    <div class="product-thumb">
                        ...
                        <div class="product-inner">
                            ...
                            <div class="product-meta">
                                <ul class="product-price-list">
                                    <li><span class="product-price">$248</span>
                                    </li>
                                </ul>
                ...
                <div class="col-md-3">
                    <div class="product-thumb">
                        ...
                        <div class="product-inner">
                            ...
                            <div class="product-meta">
                                <ul class="product-price-list">
                                    <li><span class="product-price">$294</span>
                                    </li>
                                </ul>
                                <p class="product-category"><i class="fa fa-plane"></i>travel</p>
                                <ul class="product-actions-list">
                    ...
                    <div class="product-thumb">
                        ...
                        <div class="product-inner">
                            ...
                            <div class="product-meta">
                                ...
                                <p class="product-category"><i class="fa fa-home"></i>home & garden</p>
                                <ul class="product-actions-list">
                                    <li><a class="btn btn-sm" href="#"><i class="fa fa-shopping-cart"></i> To Cart</a>
                                    </li>
                                    <li><a class="btn btn-sm"><i class="fa fa-bars"></i> Details</a>
            ...
            <div class="row row-wrap">
                <div class="col-md-4">
                    <div class="sale-point"><i class="fa fa-truck sale-point-icon"></i>
                        ...
                        <p class="sale-point-description">Ipsum gravida est phasellus eleifend conubia imperdiet sagittis mattis blandit tellus nam vel natoque dolor</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="sale-point"><i class="fa fa-tags sale-point-icon"></i>
                        <h5 class="sale-point-title">Best Discounts</h5>
                        <p class="sale-point-description">Blandit sagittis justo gravida venenatis primis vitae quisque eu vulputate bibendum lacus orci fames blandit</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="sale-point"><i class="fa fa-money sale-point-icon"></i>
                        <h5 class="sale-point-title">Guaranteed Refund</h5>
                        <p class="sale-point-description">Semper convallis tempus sociis tincidunt gravida laoreet penatibus congue iaculis dis justo ligula senectus tempor</p>
                    </div>
                </div>
            </div>
            <div class="gap gap-small"></div>
                ...
                <div class="container">
                    <div class="row row-wrap">
                        <div class="col-md-3">
                            ...
                            <p>Sapien venenatis dui consectetur magnis habitant ullamcorper tortor nibh vel elit lectus urna purus sed lobortis suscipit dictumst phasellus dis</p>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                <form>
                                    ...
                                    <p class="mb10">Tellus sed dictum ipsum taciti primis elit</p>
                            ...
                            <ul class="thumb-list">
                                <li>
                                    ...
                                    <div class="thumb-list-item-caption">
                                        ...
                                        <h5 class="thumb-list-item-title"><a href="#">Laoreet litora</a></h5>
                                        <p class="thumb-list-item-desciption">Consectetur nulla consectetur faucibus suspendisse</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                        <h5 class="thumb-list-item-title"><a href="#">Commodo eleifend</a></h5>
                                        <p class="thumb-list-item-desciption">Nunc fusce ipsum erat metus</p>
                                    </div>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                        <h5 class="thumb-list-item-title"><a href="#">Rhoncus integer</a></h5>
                                        <p class="thumb-list-item-desciption">Cum nec tellus ipsum imperdiet</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
